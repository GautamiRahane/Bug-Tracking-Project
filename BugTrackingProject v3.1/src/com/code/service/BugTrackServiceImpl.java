...
public class BugTrackServiceImpl implements BugTrackService{
	...
	@Override
	public void addBug(Bug bug) throws ErrorInExecution {
	...
	@Override
	public boolean addProject(Project project) throws ErrorInExecution {
	...
	@Override
	public void addToTeam(String projectName, int[] userIdChecked,int managerid) throws ErrorInExecution {
